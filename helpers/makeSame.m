...
nA = 6; nB = 12;
[stimAfname, trials1A] = makeEqual(nA,m1,m2);
[stimBfname, trials1B] = makeEqual(nA,m2,m1);
[stimAfname, trials2A] = makeEqual(nB,m1,m2);
[stimBfname, trials2B] = makeEqual(nB,m2,m1);
